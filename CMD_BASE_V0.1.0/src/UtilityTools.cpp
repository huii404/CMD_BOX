...
// Constructor khởi tạo tham chiếu đến SystemCore
...
void UtilityTools::uninstallBloatware() {
    ...
    cout << "\n[SUCCESS] He thong da don dep xong ung dung mac dinh!\n";
}
...
void UtilityTools::downloadManager() {
    ...
    sc.cls();
    cout << "====================================================\n";
    cout << "          TRINH TAI & CAI DAT APP TU DONG           \n";
    cout << "====================================================\n";
...
void UtilityTools::processDownload(const AppInfo &app) {
    ...
    cout << "[>] Dang khoi chay installer: " << app.fileName << "\n";
